...
hp = HumanBattleshipPlayer(g).play
...
n1.load_checkpoint('./temp/', 'checkpoint_50.pth.tar')


args1 = dotdict({'numMCTSSims': 500, 'cpuct':1.0})
...
arena = Arena.Arena(n1p, player2, g, display=BattleshipGame.display)
